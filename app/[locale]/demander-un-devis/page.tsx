...
export default async function QuotePage({
  ...
  const labels: QuoteFormLabels = {
    ...
    contactRequirement: t("quote.form.contactRequirement"),
    step: t("quote.form.step"),
    continueToProject: t("quote.form.continueToProject"),
    backToContact: t("quote.form.backToContact"),
